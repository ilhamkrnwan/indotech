...
<div class="indotech-floating-actions">
    ...
    <div class="wa-floating-row">
        ...
        <a href="#" 
           ...
           style="background-color: #25D366; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 10px rgba(0,0,0,0.15); transition: transform 0.3s ease, background-color 0.3s ease; text-decoration: none; z-index: 10000; position: relative; flex-shrink: 0;">
            <!-- Inactive icon -->
