        ...
        <nav class="primary-nav" id="primary-nav" aria-label="Navigasi Utama">
            ...
            <div class="mobile-nav-extra">
                ...
                <div class="mobile-nav-social">
                    <a href="https://www.instagram.com/orchidcareofficial" class="mn-social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <a href="https://www.facebook.com/indotechgroup/" class="mn-social-link" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
